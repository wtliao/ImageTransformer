...
from .TransformerModel4 import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
# for decoder
...
class AoAModel4(AttModel):
    def __init__(self, opt):
        super(AoAModel4, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
