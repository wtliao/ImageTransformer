...
from .TransformerModel3_old import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
# for decoder
...
class AoAModel3_old(AttModel):
    def __init__(self, opt):
        super(AoAModel3_old, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
