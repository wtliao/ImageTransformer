...
from .TransformerModel3_no_c import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
# for decoder
...
class AoAModel3_no_c(AttModel):
    def __init__(self, opt):
        super(AoAModel3_no_c, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
