...
from .TransformerModel3_d2 import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
# for decoder
...
class AoAModel3_d2(AttModel):
    def __init__(self, opt):
        super(AoAModel3_d2, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
