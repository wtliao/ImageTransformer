...
from .TransformerModel0 import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
...
class AoAModel0(AttModel):
    def __init__(self, opt):
        super(AoAModel0, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
