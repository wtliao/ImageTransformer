...
from .AttModel_rel import *
from .TransformerModel import TransformerModel
from .TransformerModelSerial import TransformerModelSerial
from .TransformerModelParallel import TransformerModelParallel
...
def setup(opt):
    ...
    elif opt.caption_model == 'serial_transformer':
        model = TransformerModelSerial(opt)
    elif opt.caption_model == 'parallel_transformer':
        model = TransformerModelParallel(opt)
    # AoANet
