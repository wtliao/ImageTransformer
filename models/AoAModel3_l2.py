...
from .TransformerModel3_l2 import LayerNorm, attention, attention_d, clones, SublayerConnection, PositionwiseFeedForward
# for decoder
...
class AoA_Refiner_Core(nn.Module):
    def __init__(self, opt):
        ...
        self.layer2 = AoA_Refiner_Layer(opt.rnn_size, attn, PositionwiseFeedForward(opt.rnn_size, 2048, 0.1) if opt.use_ff else None, 0.1)
...
class AoAModel3_l2(AttModel):
    def __init__(self, opt):
        super(AoAModel3_l2, self).__init__(opt)
        self.num_layers = 2
        # mean pooling
