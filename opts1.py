...
def parse_opt():
    ...
    # Use all train val data to fine tune model for challenge
    ...
    parser.add_argument('--aoa_num', type=int, default=6,
                        help='How many aoa modules are used in encoder?')  # NOTE: set the number of aoa module, it affects the performance critically
...
def add_eval_options(parser):
    ...
    parser.add_argument('--beam_size', type=int, default=2,
                        help='indicates number of beams in beam search. Usually 2 or 3 works well. More is not better.'
                             ' Set this to 1 for faster runtime but a bit worse performance.')
    parser.add_argument('--max_length', type=int, default=20,
                        help='Maximum length during sampling')
    parser.add_argument('--length_penalty', type=str, default='',
                        help='wu_X or avg_X, X is the alpha')
    ...
    parser.add_argument('--temperature', type=float, default=1.0,
                        help='temperature when sampling from distributions (i.e. when sample_method = sample). '
    ...
    #                     help='if nonempty then use this file in DataLoaderRaw (see docs there). Used only in MSCOCO '
