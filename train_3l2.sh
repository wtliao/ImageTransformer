# GPU_id=0
module="3l2" #3_no_c, 3_no_p_ c, 3d1, 3d2, 3d3,3d1w2,3d1w4
id="h_v"$module
caption_model="aoa"$module
refine_aoa=1
aoa_num=-2  # 6 is set in AOA, -1 , -2, and -3 are only for ablation study "l1" "l2" and "l3"
...
# echo $start_from
python -m ipdb train_h2.py --id $id --refine_aoa $refine_aoa --caption_model $caption_model --aoa_num $aoa_num\
