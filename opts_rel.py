...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='/home/liuxinyu/master_arbeit/AoA/tmp/cocotalk.json',
    ...
    parser.add_argument('--input_rel_dir', type=str, default='/home/liuxinyu/master_arbeit/tmp/union_fmap',
                        help='path to the directory containing the preprocessed rel feats, sgae_union_fmap')
    parser.add_argument('--input_box_dir', type=str, default='data/adaptive/cocobu_box',
                        help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_union_box_dir', type=str, default='/home/liuxinyu/master_arbeit/tmp/union_boxes',
                        help='path to the directory containing the boxes of rel feats')
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--cached_tokens', type=str, default='coco-train',
                        help='Cached token file for calculating cider score during self critical training.')

    # Model settings
    parser.add_argument('--caption_model', type=str, default="parallel_transformer",
                        help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer,serial_transformer, parallel_transformer')
    parser.add_argument('--fuse_type', type=int, default=2,
                        help='how to fuse obj and rel features, 1 add, 2 cat along -1')
    parser.add_argument('--rnn_size', type=int, default=1024,
                        help='size of the rnn in number of hidden nodes in each layer')
    parser.add_argument('--num_layers', type=int, default=6,
                        help='number of layers in the RNN')  # in Transformer is the number of stack of encoder/decoder layers
    parser.add_argument('--rnn_type', type=str, default='lstm',
                        help='rnn, gru, or lstm')
    parser.add_argument('--input_encoding_size', type=int, default=1024,  # d_model in Transformer
    ...
    parser.add_argument('--rel_feat_size', type=int, default=2048,
                        help='2048 for resnet, 512 for vgg')
    ...
    parser.add_argument('--norm_rel_feat', type=int, default=0,
                        help='If normalize relation features')
    parser.add_argument('--use_box', type=int, default=0,
                        help='If use box features')
    parser.add_argument('--use_union_box', type=int, default=0,
                        help='If use union box features')
    parser.add_argument('--norm_box_feat', type=int, default=0,
                        help='If use box, do we normalize box feature')
    parser.add_argument('--norm_union_box_feat', type=int, default=0,
                        help='If use union_box, do we normalize union_box feature')
    ...
    parser.add_argument('--checkpoint_path', type=str, default='log/tmp/rel',
